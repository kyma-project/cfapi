...
var _ = SynchronizedAfterSuite(func() {}, func() {
	...
	Expect(run("kubectl", "delete", "--ignore-not-found", "-f", "../../../dependencies/gateway-api")).To(Succeed())
	Expect(run("kubectl", "delete", "--ignore-not-found", "-f", "../../../dependencies/kpack")).To(Succeed())
	Expect(run("kubectl", "delete", "--ignore-not-found", "-f", "../../../dependencies/metrics-server-local")).To(Succeed())
	Expect(run("kubectl", "delete", "--ignore-not-found", "-f", "../../../module-data/envoy-filter")).To(Succeed())
