module github.com/kyma-project/cfapi/components/btp-service-broker
...
require (
	...
	github.com/SAP/sap-btp-service-operator v0.9.2
...
require (
	...
	k8s.io/apiextensions-apiserver v0.34.0-alpha.1 // indirect
