...
| ContainerRegistrySecret | Optional | `cfapi-system/dockerregistry-config-external` | Container registry secret used to push application images. It has to be of type `docker-registry`  |
